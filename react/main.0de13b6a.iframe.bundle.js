...
`;var Toggle_decorate=function(e,t,o,i){var s,d=arguments.length,r=d<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(r=(d<3?s(r):d>3?s(t,o,r):s(t,o))||r);return d>3&&r&&Object.defineProperty(t,o,r),r},Toggle_metadata=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let ToggleComponentWC=class extends lit.WF{constructor(){super(...arguments),this.label="",this.description="",this.id="",this.disabled=!1,this.checked=!1,this.required=!1,this.size=FieldSize.Default,this._toggleChangeHandler=e=>{if(this.disabled)e.preventDefault(),e.stopPropagation();else{const t=e.target;this.checked=t.checked;const o=new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0});this.dispatchEvent(o)}},this._toggleClickHandler=e=>{if(this.disabled)e.preventDefault(),e.stopPropagation();else{const e=this.shadowRoot?.querySelector("input");this.checked=!e.checked;const t=new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0});this.dispatchEvent(t)}}}static#_=this.styles=Toggle_style_css;updated(e){super.updated(e),(0,validateRequiredProperties.N)(this,["id"])}focus(){const e=this.shadowRoot?.querySelector("input");e?.focus()}render(){return lit.qy`
  ...
  `;updated(t){super.updated(t),this.style.setProperty("--ta-icon-width",this.width),this.style.setProperty("--ta-icon-height",this.height),this.fill&&this.style.setProperty("--ta-icon-user-fill",this.fill),this.isVisibleToScreenReader?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true")}render(){return lit.qy``}}base_icon_decorate([(0,decorators.MZ)({type:String}),base_icon_metadata("design:type",Object)],BaseIcon.prototype,"fill",void 0),base_icon_decorate([(0,decorators.MZ)({type:String}),base_icon_metadata("design:type",Object)],BaseIcon.prototype,"width",void 0),base_icon_decorate([(0,decorators.MZ)({type:String}),base_icon_metadata("design:type",Object)],BaseIcon.prototype,"height",void 0),base_icon_decorate([(0,decorators.MZ)({type:Boolean}),base_icon_metadata("design:type",Object)],BaseIcon.prototype,"isVisibleToScreenReader",void 0),customElements.define("ta-base-icon",BaseIcon),BaseIcon.__docgenInfo={description:"",methods:[{name:"updated",docblock:null,modifiers:[],params:[{name:"t",optional:!1,type:null}],returns:null}],displayName:"BaseIcon"};var ta_announcement_decorate=function(e,t,n,a){var o,r=arguments.length,c=r<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,n):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)c=Reflect.decorate(e,t,n,a);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(c=(r<3?o(c):r>3?o(t,n,c):o(t,n))||c);return r>3&&c&&Object.defineProperty(t,n,c),c};let AnnouncementIconWC=class extends BaseIcon{render(){return lit.qy`
    ...
    `}};SettingsIconWC=ta_settings_decorate([(0,decorators.EM)("ta-settings-icon")],SettingsIconWC);const Alert_style_css=lit.AH`
  * {
    box-sizing: border-box;
    padding: 0;
    margin: 0;
...
`;var OverlayContentAlign,t;(t=OverlayContentAlign||(OverlayContentAlign={})).TopLeft="top left",t.TopCenter="top center",t.TopRight="top right",t.MiddleLeft="middle left",t.MiddleCenter="middle center",t.MiddleRight="middle right",t.BottomLeft="bottom left",t.BottomCenter="bottom center",t.BottomRight="bottom right";var Base_decorate=function(t,e,o,i){var s,n=arguments.length,r=n<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,o,i);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,o,r):s(e,o))||r);return n>3&&r&&Object.defineProperty(e,o,r),r},Base_metadata=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let OverlayComponentWC=class extends lit.WF{constructor(){super(...arguments),this.id="",this.visible=!1,this.containerId="",this.overlayContentAlign=OverlayContentAlign.MiddleCenter,this._focusListener=void 0,this._isFirstUpdate=!0}static#_=this.styles=Base_style_css;updated(t){super.updated(t),(0,validateRequiredProperties.N)(this,["id"]);const e=this.shadowRoot?.host,o=this.overlayContentAlign.split(" ");e.style.alignItems="middle"===o[0]?"center":"top"===o[0]?"flex-start":"flex-end",e.style.justifyContent="center"===o[1]?"center":"left"===o[1]?"flex-start":"flex-end",this.visible&&(this._activeOverlay(),this._isFirstUpdate=!1),this.visible||this._isFirstUpdate||this._deactivateOverlay()}_dispatchOnActiveFocus(){const t=new CustomEvent("onActiveFocus",{bubbles:!0,composed:!0});this.dispatchEvent(t)}_dispatchOnDeActiveFocus(){const t=new CustomEvent("onClose",{bubbles:!0,composed:!0});this.dispatchEvent(t)}_activeOverlay(){let t=this.shadowRoot?.host;this.containerId&&(t=document.getElementById(this.containerId)),this._focusListener=()=>{t.contains(document.activeElement)||this._dispatchOnActiveFocus()},document.addEventListener("focus",this._focusListener,!0),this._dispatchOnActiveFocus()}_deactivateOverlay(){this._focusListener&&(document.removeEventListener("focus",this._focusListener,!0),this._focusListener=void 0),this._dispatchOnDeActiveFocus()}render(){return lit.qy`<slot></slot>`}};Base_decorate([(0,decorators.MZ)({type:String,reflect:!0}),Base_metadata("design:type",Object)],OverlayComponentWC.prototype,"id",void 0),Base_decorate([(0,decorators.MZ)({type:Boolean,reflect:!0}),Base_metadata("design:type",Boolean)],OverlayComponentWC.prototype,"visible",void 0),Base_decorate([(0,decorators.MZ)({type:String}),Base_metadata("design:type",Object)],OverlayComponentWC.prototype,"containerId",void 0),Base_decorate([(0,decorators.MZ)({type:String}),Base_metadata("design:type",String)],OverlayComponentWC.prototype,"overlayContentAlign",void 0),OverlayComponentWC=Base_decorate([(0,decorators.EM)("ta-overlay")],OverlayComponentWC);const Modal_style_css=lit.AH`
  * {
    box-sizing: border-box;
    padding: 0;
    margin: 0;
...
`;var Modal_decorate=function(t,e,o,i){var a,s=arguments.length,n=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,i);else for(var r=t.length-1;r>=0;r--)(a=t[r])&&(n=(s<3?a(n):s>3?a(e,o,n):a(e,o))||n);return s>3&&n&&Object.defineProperty(e,o,n),n},Modal_metadata=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let ModalComponentWC=class extends lit.WF{constructor(){super(...arguments),this.id="",this.title="",this.visible=!1,this._focusListener=void 0,this._isFirstUpdate=!0}static#_=this.styles=Modal_style_css;updated(t){super.updated(t),(0,validateRequiredProperties.N)(this,["id"])}_dispatchOnActiveFocus(){const t=this.shadowRoot?.querySelector(`#${this.id}-close-button`);t&&t.focus()}_dispatchOnClose(t){t.stopPropagation();const e=new CustomEvent("onClose",{bubbles:!0,composed:!0});this.dispatchEvent(e)}render(){return lit.qy`<ta-overlay
      id="${`${this.id}-overlay-container`}"
      .visible="${this.visible}"
      .containerId="${this.id}"
      @onActiveFocus="${this._dispatchOnActiveFocus}"
...
//# sourceMappingURL=main.0de13b6a.iframe.bundle.js.map